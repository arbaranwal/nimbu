...
/**
 * @brief Calculates FFT and updates top 5 peaks in f_peaks
 * If sample size is not a power of 2,  it will be clipped to the lower exponent.
 * 
 * @param in        data array
 * @param N         sample size (power of 2)
 * @param Frequency sampling frequency (Hz)
 */
void FFT(int in[],int N,float Frequency)
{
    ...
    int i10,i11,n1;
    float e,c,s,tr,ti;      // exp, sine, cos, treal, timg
    ...
    /// out_r contains amplitude and our_in conntains frequency (Hz)
